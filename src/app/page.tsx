  ...
  return (
    <main>
      <section className="relative w-full bg-cx-navy text-white overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=2200&q=70&sat=-100"
          alt=""
          aria-hidden
          className="pointer-events-none select-none absolute inset-0 h-full w-full object-cover object-right opacity-60 grayscale"
        />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-l from-cx-navy/85 via-cx-navy/45 to-cx-navy/0" />
